  ...
  return (
    <div style={{ padding: "2rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1rem", marginBottom: "2rem" }}>
        {[
          { label: "Total Sanctioned", value: fmt(totalSanctioned), color: "#6366f1" },
          ...
          <div key={label} style={{ background: "#1e293b", borderRadius: "12px", padding: "1.25rem", border: "1px solid #334155" }}>
            <p style={{ color: "#94a3b8", fontSize: "0.85rem", marginBottom: "0.5rem" }}>{label}</p>
      ...
      {/* Bar Chart */}
      <div style={{ background: "#1e293b", borderRadius: "12px", padding: "1.5rem", border: "1px solid #334155", marginBottom: "2rem" }}>
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={chartData} margin={{ top: 5, right: 20, left: 20, bottom: 5 }}>
            ...
            <Tooltip formatter={(val) => fmt(val)} contentStyle={{ background: "#0f172a", border: "1px solid #334155", borderRadius: "8px" }} />
            <Legend />
            <Bar dataKey="Sanctioned" fill="#6366f1" radius={[4, 4, 0, 0]} />
            ...
            {DUMMY_BUDGET.map((road, i) => {
              ...
              return (
                <tr key={i} style={{ background: i % 2 === 0 ? "#0f172a" : "#1e293b" }}>
                  ...
                  <td style={{ padding: "0.75rem 1rem", color: "#94a3b8" }}>{road.contractor_name}</td>
                  ...
                  <td style={{ padding: "0.75rem 1rem" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                      <div style={{ flex: 1, background: "#334155", borderRadius: "999px", height: "6px" }}>
